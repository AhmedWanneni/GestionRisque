...
import { Modifier_Mesures } from '../../Utils/Gestion';
import Sidebar from '../SideBar';
import TopBar from '../TopBar';

export default class ModiferMesures extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: false,
    ...
    SaveData = () => {
        ...
        Modifier_Mesures(id, occ, type, ordrePriorite, solution, valeur);
    };
    render() {
        let { id, occ, type, ordrePriorite, valeur, solution } = this.state;
        ...
        return (
            ...
            <>
                ...
                <div class="content-wrapper ajouter-wrap">
                    ...
                    <FormControl className="form-control-trait">
                        <TextField valeur={occ} id="standard-basic" multiline rowMax={4}
                            label="description : " onChange={this.handleOccChange} />
                    ...
                    <div className="btn-menace">
                        <Button variant="contained" color="primary" onClick={this.SaveData}>Modifier Mesures</Button>
                    </div>
                </div>
            </>
        );
