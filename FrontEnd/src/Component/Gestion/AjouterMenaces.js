...
export default class AjouterMenaces extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: false,
    ...
    SaveData = () => {
        ...
        Ajouter_Menaces(id, desc, acces, acteur, type, motivation, resultat, incident_passe, valeur);
        window.location = './gestion-menaces';
    };
    render() {
        let { id, desc, acces, acteur, type, motivation, resultat, incident_passe, valeur } = this.state;
        ...
        return (
            ...
            <>
                ...
                <div class="content-wrapper ajouter-wrap">
                    {/* ID */}
                    <TextField valeur={id} id="standard-basic" multiline rowMax={4} 
                    label=" id: " onChange={this.handleIdChange} />
                    ...
                    {/*Acces*/}
                    <TextField valeur={acces} id="standard-basic"  multiline rowMax={4}
                    label="Acces : " onChange={this.handleAccesChange} />
                    ...
                    <TextField valeur={resultat} id="standard-basic" multiline rowMax={4} label="resultat" onChange={this.handleResultatChange} />
