...
import { Modifier_Actifs, Ajouter_Menaces } from '../../Utils/Gestion';
...
export default class AjouterActifs extends Component {
    ...
    Modifier_Actifs(id,id_session,desc, lieu, propr, type,integrite,disponibilite,confidentialite,mesure,valeur);
     alert("actif Modifier");
